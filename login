...
<head>
    ...
    <title>Login - Python Daily Challenges</title>
...
<body>
                ...
                <div class="card bg-dark shadow-sm border-0">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            <h2>Login</h2>
                            <p class="text-muted">Sign in to continue to your challenges</p>
                        </div>
    ...
    <footer class="py-4 bg-dark mt-5">
        <div class="container text-center">
            <p class="text-muted mb-0">Python Daily Challenges &copy; 2025</p>
        </div>
    </footer>
